...
def construct_optimizer(model, cfg):
    ...
    # Apply different weights decay to Batchnorm and non-batchnorm parameters.
    # In Caffe2 classification codebase the weights decay for batchnorm is 0.0.
    # Having a different weights decay on batchnorm might cause a performance
    # drop.
    optim_params = [
...
def get_epoch_lr(cur_epoch, cfg):
    ...
    Args:
        ...
        learning rate, betas, and weights decays.
