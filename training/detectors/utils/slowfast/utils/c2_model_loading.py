...
def get_name_convert_func():
    ...
    pairs = [
        # ------------------------------------------------------------
        # 'nonlocal_conv3_1_theta_w' -> 's3.pathway0_nonlocal3.conv_g.weights'
        [
        ...
        # 'nonlocal_conv4_5_bn_s' -> 's4.pathway0_nonlocal3.bn.weights'
        ...
        # 'res4_0_branch1_w' -> 'S4.pathway0_res0.branch1.weights'
        [
